function Contact() {
  return (
    <div className="w-screen min-h-screen p-5">
      <h1 className="md:text-4xl text-3xl border-b-4 pb-2 mb-10 mt-4 border-sky-400 mx-auto md:w-[200px] w-[170px] font-bold">
        Contact Me
      </h1>
      <form className="flex flex-col justify-start mx-auto md:w-3/6 w-3/4 items-start p-10 rounded-lg space-y-5 bg-white shadow-lg h-[80vh] overflow-hidden border-2">
